  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Category colors
        stories: {
          DEFAULT: "hsl(var(--stories))",
          foreground: "hsl(var(--stories-foreground))",
        },
        poems: {
          DEFAULT: "hsl(var(--poems))",
          foreground: "hsl(var(--poems-foreground))",
        },
        drawings: {
          DEFAULT: "hsl(var(--drawings))",
          foreground: "hsl(var(--drawings-foreground))",
        },
        news: {

...
export function HeroSection() {
  ...
  return (
    <section className="relative pt-8 pb-20 md:pt-12 md:pb-32 overflow-hidden bg-background">
      ...
      <div className="absolute top-20 left-[10%] opacity-80 animate-float animation-delay-100 hidden md:block">
      ...
      <div className="container relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="flex-1 text-center lg:text-left space-y-6 md:space-y-8 pt-8 lg:pt-0">
            {/* Playful Badge */}
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border-2 border-primary/20 px-4 py-2 rounded-full shadow-sm animate-fade-in mx-auto lg:mx-0">
              <span className="text-xl">✨</span>
              <span className="font-bold text-primary tracking-wide text-sm md:text-base">Welcome to ZeeQue World!</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start pt-4 z-30 relative">
              ...
              <Button
                ...
                variant="outline"
                size="xl"
                className="rounded-full px-8 py-7 text-xl font-bold bg-white border-2 border-sky-500 text-sky-500 shadow-[0_10px_20px_-5px_rgba(14,165,233,0.5)] hover:bg-white hover:text-sky-600 hover:border-sky-600 hover:shadow-[0_15px_25px_-5px_rgba(14,165,233,0.6)] hover:-translate-y-1 transition-all duration-300 w-full sm:w-auto mt-2"
              >
          ...
          <div className="flex-1 relative w-full max-w-[500px] lg:max-w-none">
            <div className="relative aspect-square md:aspect-[4/3] lg:aspect-square flex items-center justify-center">
              ...
              <div className="absolute top-[10%] right-[10%] bg-white p-4 rounded-3xl shadow-card animate-float animation-delay-200">
                <Music className="w-8 h-8 text-pink-500" />
              </div>
              <div className="absolute bottom-[20%] left-[5%] bg-white p-4 rounded-3xl shadow-card animate-float animation-delay-500">
      ...
      <div className="absolute bottom-[-1px] left-0 w-full overflow-hidden leading-none rotate-180 z-20 pointer-events-none">
        <svg className="relative block w-full h-[60px] md:h-[120px]" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" className="fill-white dark:fill-card"></path>
        </svg>
      </div>
    </section>
  );

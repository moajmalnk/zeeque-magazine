              ...
              <div className="space-y-1">
                ...
                {(post.teacher_name || post.school_name) && (
                  <div className="text-xs text-muted-foreground space-y-0.5">
                    {post.teacher_name && (
                      <p>Teacher: <span className="font-medium text-foreground">{post.teacher_name}</span></p>
                    )}
                    {post.school_name && (
                      <p>School: <span className="font-medium text-foreground">{post.school_name}</span></p>
                    )}
                  </div>
                )}
              </div>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription className="space-y-2">
                        <p>
                          Are you sure you want to reject <strong>"{post.title}"</strong> by {post.author_name}?
                        </p>
